        ...
        <div class="modal-result-header">
            <div class="modal-result-header__title">
					...
					<div class="modal-result-header__title__explain">
						...
						<div class="modal-result-header__toggle-text" style="${utils.getInlineStyle(style)}">${ completionList ? "기이수" : "미이수" }</div>
						<div class="modal-result-header__toggle-left">한 과목이 표시됩니다.</div>
					</div>
			</div>
